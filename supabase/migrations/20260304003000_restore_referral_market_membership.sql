-- ============================================================================
-- Restore referral market membership schema after rollback
-- Re-adds objects dropped by:
--   20260304002000_rollback_referral_market_membership_and_recover_placeholder.sql
-- ============================================================================
...
-- 6) Keep referral tables server-side only (service_role bypasses RLS)
