...
class GoNativeWebChromeClient extends WebChromeClient {
    ...
    public boolean onCreateWindow(WebView view, boolean isDialog, boolean isUserGesture, Message resultMsg) {
        // Alipay cashier pages frequently try to open a new window (target=_blank / window.open).
        // In a WebView shell this becomes a second web page, and then Alipay also opens the native app,
        // which looks like “two pop-ups”. Block new-window creation for Alipay domains.
        try {
