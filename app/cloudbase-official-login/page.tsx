...
export default function OfficialCloudBaseLogin() {
  ...
  const [loginMethod, setLoginMethod] = useState<"wechat" | "email">(
    detectPlatform().type.includes('app') ? "email" : "wechat"
  );
          ...
          {isLoggedIn && userInfo ? (
            ...
            <div className="space-y-6">
              ...
              <div className="flex border-b border-gray-200">
                ...
                <button
                  onClick={() => setLoginMethod(platformInfo.type === 'ios-app' ? "email" : "email")}
                  className={`${
                    platformInfo.type === 'ios-app' ? 'flex-1' : 'flex-1'
              ...
              {loginMethod === "wechat" && !platformInfo.type.includes('app') ? (
                /* 微信登录 */
                <div className="space-y-6">
                  <div className="text-center">
                    <div className="w-16 h-16 bg-green-100 rounded-full flex items-center justify-center mx-auto mb-4">
